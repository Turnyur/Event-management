...
if ( $_REQUEST['token']==$_SESSION['token'] && isset($actions[$_REQUEST['action']]) ) {
     $use_array = $actions[$_REQUEST['action']];     
     $obj = new $use_array['object']($dbo); //new Calendar($dbo) 

//This is the part where processForm Method in the Calendar class was called!

     if ( TRUE === $msg=$obj->$use_array['method']() /* $obj-.processForm() */){      
